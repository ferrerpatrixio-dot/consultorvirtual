...
- **Unsplash**: `UNSPLASH_API_KEY` (principal) -> [unsplash.com/developers](https://unsplash.com/developers)
- **Pexels**: `PEXELS_API_KEY` (secundaria) -> [pexels.com/api](https://www.pexels.com/api/)
- **Pixabay**: `PIXABAY_API_KEY` (fallback) -> [pixabay.com/api/docs](https://pixabay.com/api/docs/)
...
2. **Ejecución del Script**: Ejecuta el script especificando el archivo de consultas, la carpeta de destino (`./fotos_solicitadas/`) y la fuente principal (Unsplash por defecto):
   ```bash
